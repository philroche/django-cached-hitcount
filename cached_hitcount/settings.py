...
CACHED_HITCOUNT_ENABLED = gargoyle.is_active('cached_hitcount', default=True)#TODO also check that there is a CACHES setting
CACHED_HITCOUNT_CACHE = getattr(settings, 'HITCOUNT_CACHE', 'hitcount_cache')#The CACHES settings dict key to use for caching hits
